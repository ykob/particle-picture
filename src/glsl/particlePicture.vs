...
void main(void) {
  ...
  vec3 updatePosition = position + vec3(
    vsin * vcos * noiseRadius * noise * stepPrev * stepNext,
    vcos * noiseRadius * noise * stepPrev * stepNext,
    vsin * vsin * noiseRadius * noise * stepPrev * stepNext
  );
